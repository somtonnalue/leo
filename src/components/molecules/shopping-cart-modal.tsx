...
export default function ShoppingCartModal() {
	const { cartCount, totalPrice, shouldDisplayCart, handleCartClick, cartDetails, removeItem, redirectToCheckout } = useShoppingCart();
			...
			<SheetContent>
				...
				<div className="h-full flex flex-col justify-between">
					...
					<div className="border-t border-gray-200 px-4 py-6 sm:px-6">
						...
						<p className="mt-.5 text-sm text-gray-500">Shipping and taxes are calculated at checkout.</p>
						<div className="mt-6">
